...
from render.security import verify_password
...
async def authenticate_user(
        username: str, password: str, user_collection
) -> Union[User, bool]:
...
async def get_user(username, users_collection) -> Optional[User]:
...
def get_current_user(
    ...
    try:
        ...
        raise credentials_exception
    user = get_user(username=token_data.username, users_collection=user_collection)
    if user is None:
        raise credentials_exception
